...
export class ComunicaEngine {
   ...
   */
  constructor(defaultSource, options, comunica) {
    this._engine = comunica;
    this._options = options; // Preload sources but silence errors; they will be thrown during execution
